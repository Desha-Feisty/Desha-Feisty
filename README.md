...
- 🧠 Interested in: Full-Stack Web Dev, AI/ML Integration, Real-Time Systems, EdTech
...
| 🎓 LMS Platform | 💬 Real-Time Chat | 🤖 AI Integration | 🔐 Auth Systems |
|---|---|---|---|
| Full-featured Learning Management System with quiz grading, analytics, and role management | Socket.io-based instant messaging with media sharing | Gemini AI-powered quiz generation and grading with file upload support | JWT authentication with email verification and refresh tokens |
